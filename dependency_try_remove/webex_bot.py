...
from dependency_try_remove.help import HelpCommand
from dependency_try_remove.my_help import Respuesta
...
class WebexBot(WebexWebsocketClient):
    ...
    def __init__(self,
        ...
        self.initial_command = Respuesta()
        self.help_command = HelpCommand(
            bot_name=bot_name,
            bot_help_subtitle=bot_help_subtitle,
            bot_help_image=self.teams.people.me().avatar
            #bot_help_image=Image(url='https://placeimg.com/200/200/tech')
            )
        self.commands = {
            self.help_command
        }
