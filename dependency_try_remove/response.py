...
def response_from_adaptive_card_kvargs(adaptive_card: AdaptiveCard, **kvargs):
    """
    Conven
    ard.
...
class Response(object):
    def __init__(self, attributes=None):
        if attributes:
            ...
            self.attributes["toPersonEmail"] = None
    ...
    def toPersonEmail(self):
        return self.attributes["toPersonEmail"]

    @toPersonEmail.setter
    def toPersonEmail(self, val):
        self.attributes["toPersonEmail"] = val
